...
image_paths = [
    os.path.join(os.path.realpath("."), "./mnist/train/" + image_name)
    for image_name in os.listdir("./mnist/train")
]
image_paths += [
    os.path.join(os.path.realpath("."), "./mnist/test/" + image_name)
    for image_name in os.listdir("./mnist/test")
]
    ...
    with open(flags.labels_txt, "w") as wf:
        ...
        while image_num < flags.images_num:
            image_path = os.path.realpath(
                os.path.join(flags.images_path, "%06d.jpg" % (image_num + 1)))
